...
module top ;
    ...
    CyControlReg_v1_80 c_register (
        ...
        .control_7(Net_21),
        .reset(1'b0));
    defparam c_register.Bit0Mode = 0;
    defparam c_register.Bit1Mode = 0;
    defparam c_register.Bit2Mode = 0;
    defparam c_register.Bit3Mode = 0;
    defparam c_register.Bit4Mode = 0;
    defparam c_register.Bit5Mode = 0;
    defparam c_register.Bit6Mode = 0;
    defparam c_register.Bit7Mode = 0;
    defparam c_register.BitValue = 0;
    defparam c_register.BusDisplay = 0;
    defparam c_register.ExtrReset = 0;
    defparam c_register.NumOutputs = 3;
	...
	wire [0:0] tmpOE__b_encoder_net;
	wire [0:0] tmpFB_0__b_encoder_net;
	wire [0:0] tmpIO_0__b_encoder_net;
	electrical [0:0] tmpSIOVREF__b_encoder_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("199c2740-ff3c-4175-ad4f-a99201ba3df3"),
		  ...
		  .input_buffer_sel(2'b00))
		b_encoder
		 (.oe(tmpOE__b_encoder_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__b_encoder_net[0:0]}),
		  .io({tmpIO_0__b_encoder_net[0:0]}),
		  .siovref(tmpSIOVREF__b_encoder_net),
		  .interrupt({Net_43}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__b_encoder_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
