...
#define ADC_SAR_Seq_TOTAL_CHANNELS_NUM             (2u)
#define ADC_SAR_Seq_SEQUENCED_CHANNELS_NUM         (2u)
#define ADC_SAR_Seq_DEFAULT_EN_CHANNELS            (3u)
#define ADC_SAR_Seq_NOMINAL_CLOCK_FREQ             (6000000)
