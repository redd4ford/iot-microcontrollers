    ...
    uint8 tmpCnt;
        ...
        */
        ...
        count = (int8) ((int16) tmpCnt -
                (int16) QuadDec_COUNTER_INIT_VALUE);
...
*
*******************************************************************************/
void QuadDec_SetCounter(int8 value) 
{
    #if ((QuadDec_COUNTER_SIZE == QuadDec_COUNTER_SIZE_8_BIT) || \
         (QuadDec_COUNTER_SIZE == QuadDec_COUNTER_SIZE_16_BIT))
        uint8 count;
        ...
        if (value >= 0)
        {
            count = (uint8) value + QuadDec_COUNTER_INIT_VALUE;
        }
        else
        {
            count = QuadDec_COUNTER_INIT_VALUE - (uint8)(-value);
        }
        #if (QuadDec_COUNTER_SIZE == QuadDec_COUNTER_SIZE_8_BIT)
