...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\CyControlReg_v1_80\CyControlReg_v1_80.v"
`endif
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("08eb6e1e-18df-4ca0-9368-878a777a21d8/ed092b9b-d398-4703-be89-cebf998501f6"),
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\cy_virtualmux_v1_0\cy_virtualmux_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\ZeroTerminal\ZeroTerminal.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyComponentLibrary\CyComponentLibrary.cylib\bQuadDec_v3_0\bQuadDec_v3_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0\not_v1_0.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\not_v1_0\not_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\and_v1_0\and_v1_0.v"
`endif
...
`ifdef WARP
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal\OneTerminal.v"
`else
`define CY_BLK_DIR "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal"
`include "D:\program files\Cypress\PSoC\PSoC Creator\4.4\PSoC Creator\psoc\content\CyPrimitives\cyprimitives.cylib\OneTerminal\OneTerminal.v"
`endif

// QuadDec_v3_0(Counter8bit=true, CounterResolution=1, CounterSize=8, CounterSizeReplacementString=int8, CounterSizeReplacementStringUnsigned=uint8, TypeCastReplacementString=int16, UsingGlitchFiltering=false, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONFIG_TITLE=QuadDec, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=QuadDec, CY_INSTANCE_SHORT_NAME=QuadDec, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=QuadDec, )
...
module top ;
	...
	wire [0:0] tmpOE__SGN_4_net;
	wire [0:0] tmpFB_0__SGN_4_net;
	wire [0:0] tmpIO_0__SGN_4_net;
	wire [0:0] tmpINTERRUPT_0__SGN_4_net;
	electrical [0:0] tmpSIOVREF__SGN_4_net;

	cy_psoc3_pins_v1_10
		#(.id("9f81b243-750a-47eb-9daf-8f4d1affabb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SGN_4
		 (.oe(tmpOE__SGN_4_net),
		  .y({Net_74}),
		  .fb({tmpFB_0__SGN_4_net[0:0]}),
		  .io({tmpIO_0__SGN_4_net[0:0]}),
		  .siovref(tmpSIOVREF__SGN_4_net),
		  .interrupt({tmpINTERRUPT_0__SGN_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SGN_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Button_inc_net;
	wire [0:0] tmpFB_0__Button_inc_net;
	wire [0:0] tmpIO_0__Button_inc_net;
	electrical [0:0] tmpSIOVREF__Button_inc_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("5a4d9727-80df-42ba-b573-beb9117d113d"),
		  ...
		  .input_buffer_sel(2'b00))
		Button_inc
		 (.oe(tmpOE__Button_inc_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_inc_net[0:0]}),
		  .io({tmpIO_0__Button_inc_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_inc_net),
		  .interrupt({Net_33}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_inc_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__SGN_1_net;
	wire [0:0] tmpFB_0__SGN_1_net;
	wire [0:0] tmpIO_0__SGN_1_net;
	wire [0:0] tmpINTERRUPT_0__SGN_1_net;
	electrical [0:0] tmpSIOVREF__SGN_1_net;
	...
	cy_psoc3_pins_v1_10
		...
		SGN_1
		 (.oe(tmpOE__SGN_1_net),
		  .y({Net_65}),
		  .fb({tmpFB_0__SGN_1_net[0:0]}),
		  .io({tmpIO_0__SGN_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SGN_1_net),
		  .interrupt({tmpINTERRUPT_0__SGN_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SGN_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SGN_2_net;
	wire [0:0] tmpFB_0__SGN_2_net;
	wire [0:0] tmpIO_0__SGN_2_net;
	wire [0:0] tmpINTERRUPT_0__SGN_2_net;
	electrical [0:0] tmpSIOVREF__SGN_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		SGN_2
		 (.oe(tmpOE__SGN_2_net),
		  .y({Net_68}),
		  .fb({tmpFB_0__SGN_2_net[0:0]}),
		  .io({tmpIO_0__SGN_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SGN_2_net),
		  .interrupt({tmpINTERRUPT_0__SGN_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SGN_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SGN_3_net;
	wire [0:0] tmpFB_0__SGN_3_net;
	wire [0:0] tmpIO_0__SGN_3_net;
	wire [0:0] tmpINTERRUPT_0__SGN_3_net;
	electrical [0:0] tmpSIOVREF__SGN_3_net;
	...
	cy_psoc3_pins_v1_10
		...
		SGN_3
		 (.oe(tmpOE__SGN_3_net),
		  .y({Net_71}),
		  .fb({tmpFB_0__SGN_3_net[0:0]}),
		  .io({tmpIO_0__SGN_3_net[0:0]}),
		  .siovref(tmpSIOVREF__SGN_3_net),
		  .interrupt({tmpINTERRUPT_0__SGN_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SGN_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Button_dec_net;
	wire [0:0] tmpFB_0__Button_dec_net;
	wire [0:0] tmpIO_0__Button_dec_net;
	electrical [0:0] tmpSIOVREF__Button_dec_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Button_dec
		 (.oe(tmpOE__Button_dec_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_dec_net[0:0]}),
		  .io({tmpIO_0__Button_dec_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_dec_net),
		  .interrupt({Net_28}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_dec_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a0a9b0d5-0c16-42cd-9d3e-12346a55e0b7"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1e5382af-27d6-45e1-80db-3850eca84ba5"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b5844bf2-252e-47de-bba4-786e61edd74b"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Button_direction_net;
	wire [0:0] tmpFB_0__Button_direction_net;
	wire [0:0] tmpIO_0__Button_direction_net;
	electrical [0:0] tmpSIOVREF__Button_direction_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("199c2740-ff3c-4175-ad4f-a99201ba3df3"),
		  ...
		  .input_buffer_sel(2'b00))
		Button_direction
		 (.oe(tmpOE__Button_direction_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Button_direction_net[0:0]}),
		  .io({tmpIO_0__Button_direction_net[0:0]}),
		  .siovref(tmpSIOVREF__Button_direction_net),
		  .interrupt({Net_36}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Button_direction_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    TCPWM_P4_v2_10_3 Timer_Counter (
        .capture(1'b0),
        .cc(Net_43),
        .clock(Net_46),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("9c7f41c9-302a-4003-bacb-4f07012f02ff"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000000"),
		  .is_direct(0),
    ...
    assign Net_65 = Net_63 & Net_73;


    assign Net_68 = Net_66 & Net_73;


    assign Net_71 = Net_69 & Net_73;


    assign Net_74 = Net_72 & Net_73;
